...
public class BrickBrickEntity extends AbstractHorseEntity {
    ...
    public BrickBrickEntity(EntityType<? extends AbstractHorseEntity> type, World world) {
        super(type, world);
    }
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (!held.isEmpty()) {
            if (this.isBreedingItem(held)) {
                ...
                if (this.isBaby()) {
                    this.eat(player, hand, held);
                    this.growUp(BrickBrickEntity.toGrowUpAge(-i), true);
                    return ActionResult.SUCCESS;
                }
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return BRICK_BRICK.create(world, SpawnReason.BREEDING);
    }
}
